		    ...
		    <div class="container">
				...
				<div class="row">
					...
					<div class="mt-2 col-sm-12 text-center">
						<a href="add_recipes.php" class="btn_1 gradient" style="width: 1000px">Add Recipes</a>
                        <a href="my_recipes.php" class="btn_1 gradient" style="width: 200px">My Recipes</a>
					</div>
                    <?php }
                            else{} ?>
				</div>
			...
			<div class="row">
				<div class="col-lg-9">
					<div class="row">
						...
						$query = mysqli_query($connect, "SELECT * FROM recipes as r join user as u on r.rc_us_id=u.us_id where u.us_id = $cid order by rc_rating DESC ");
						while ($row = mysqli_fetch_array($query)) {
							?>
						<div class="col-md-6">
							<article class="blog">
								<figure>
									<a href="recipes-post.php?rcid=<?php echo htmlentities($row['rc_id']); ?>"><img src="img2/<?php echo htmlentities($row['rc_img']); ?>" alt="">
										<div class="preview"><span>Read more</span></div>
									</a>
								</figure>
								<div class="post_info">
									<small><?php echo htmlentities($row['rc_time']); ?></small>
									<h2><a href="recipes-post.php?rcid=<?php echo htmlentities($row['rc_id']); ?>"><?php echo htmlentities($row['rc_title']); ?></a></h2>
									
									<ul>
                                        <div>
                                                    <a href="delete_recipes.php?fid=<?php echo htmlentities($row['rc_id']) ?>" class="btn_1 gradient" >Delete</a>
                                                    <a href="edit_recipes.php?fid=<?php echo htmlentities($row['rc_id']) ?>" class="btn_1 gradient" >Edit</a>
                                        </div>
										<li>
											<div class="thumb"><img src="img2/<?php echo htmlentities($row['us_pic']); ?>" alt=""></div> <?php echo htmlentities($row['us_name']); ?>
										</li>
										<li>
							        	<div class="score"><strong><?php echo htmlentities($row['rc_rating']); ?></strong></div>
							        	</li>
									</ul>
								</div>
							</article>
