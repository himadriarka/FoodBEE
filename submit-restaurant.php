...
<body>
	...
	<main>
		<div class="hero_single inner_pages background-image" data-background="url(img2/home_section_2.jpg)">
			<div class="opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.6)">
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-10">
							<h1>Attract New Customers</h1>
							<p>Join Foodbee and expand your horizons - attract new customers and watch your business flourish</p>
		...
		<!-- /hero_single -->
			...
			<div class="main_title center">
				<span><em></em></span>
				<h2>Why Submit to FoodBEE</h2>
				<p>Joining Foodbee is not just a way to expand your reach and attract new customers, it's an opportunity to showcase your culinary expertise and passion for food to a diverse and enthusiastic audience.</p>
			</div>
			...
			<div class="row justify-content-center align-items-center add_bottom_15">
					<div class="col-lg-6">
						<div class="box_about">
							...
							<p class="lead">Experience the power of Foodbee's online food delivery service and see your restaurant thrive with increased bookings, customer loyalty, and brand exposure - take your business to new heights with Foodbee today.</p>
				...
				<div class="row justify-content-center align-items-center add_bottom_15">
					...
					<div class="col-lg-6">
						<div class="box_about">
							<h3>Manage Easly</h3>
							<p class="lead">Managing your restaurant has never been easier - with Foodbee, you have access to a powerful online platform that simplifies everything from orders and payments to inventory and customer feedback, giving you more time to focus on what matters most - creating delicious food and delivering a memorable dining experience.</p>
				...
				<div class="row justify-content-center align-items-center">
					<div class="col-lg-6">
						<div class="box_about">
							...
							<p class="lead">Expand your customer base and reach new heights with Foodbee - the online food delivery platform that connects you with hungry customers looking for delicious and convenient dining options. With Foodbee, the possibilities are endless - join today and start reaching new customers in your area.</p>
						</div>
				...
				<div class="row justify-content-center">
					<div class="col-lg-5">
						...
						<div id="message-register"></div>
                            <form class="ui form" method=post enctype="multipart/form-data" action=submit_owner.php >
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<input type="text" class="form-control" placeholder="Restaurant Name" name="restaurantname" id="restaurantname_register">
										</div>
									</div>
								</div>
								<!-- /row -->
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<input type="text" class="form-control" placeholder="Address" name="address" id="address_register">
										</div>
									</div>
								</div>
                                <div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<input type="text" class="form-control" placeholder="Restaurant email" name="r_email" id="email_register">
										</div>
									</div>
								</div>
                                <div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<input type="text" class="form-control" placeholder="Restaurant type" name="r_food_type" id="foodtype_register">
										</div>
									</div>
								</div>
								<!-- /row -->
