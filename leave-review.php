		        ...
		        <div class="col-lg-8">
					...
					<?php
							...
							while ($row=mysqli_fetch_array($query)) {
								?>
		                <h1 class="add_bottom_15">Write a review for <?php echo htmlentities($row['r_name']); ?></h1>
						<?php } ?>
						<form class="ui form" method=get action=comment.php>
						...
						<input type="hidden" name=rid value="<?php echo $pid ?>"> 
                        <input type="hidden" name=cid value="<?php echo $cid ?>">
		                <div class="form-group">
		                    <label>Title of your review</label>
		                    <input class="form-control" type="text" placeholder="If you could say it in one sentence, what would you say?" name=t_body>
		                </div>
		                <div class="form-group">
		                    <label>Your review</label>
		                    <textarea class="form-control" style="height: 180px;" placeholder="Write your review to help others learn about this online business" name=body></textarea>
		                </div>
		                <div class="form-group">
