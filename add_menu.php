		    ...
		    <div class="row justify-content-center">
		        <div class="col-lg-8">
		            <div class="box_general write_review">
		                ...
		                <h1 class="add_bottom_15">Add Item </h1>
						
						<form class="ui form" method=get action=.php>
		
						
		                <div class="form-group">
		                    <label>Name of the Food Item</label>
		                    <input class="form-control" type="text" placeholder="" name=t_body>
		                </div>
		                <div class="form-group">
		                    <label>Details</label>
		                    <textarea class="form-control" style="height: 180px;" placeholder="Write your details about our food item" name=body></textarea>
		                </div>
		                <div class="form-group">
