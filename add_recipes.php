		    ...
		    <div class="row justify-content-center">
		        <div class="col-lg-8">
		            <div class="box_general write_review">
		                ...
		                <h1 class="add_bottom_15">Add Recipes</h1>
						
						<form class="ui form" method="post" enctype="multipart/form-data" action="recipes_entry.php">
                            <div class="form-group">
		                        <label>Title of your Recipes</label>
		                        <input class="form-control" type="text" placeholder="Name of your Food" name=rc_title>
		                    </div>
		                    <div class="form-group">
		                        <label>Post</label>
		                        <textarea class="form-control" style="height: 180px;" placeholder="Instruction" name=rc_post></textarea>
		                    </div>
		                    <div class="form-group">
